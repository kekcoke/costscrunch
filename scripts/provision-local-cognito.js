...
async function run() {
  try {
    ...
    // Write IDs to .env file for dynamic propagation
    const envContent = `# Auto-generated by provision-local-cognito.js - DO NOT COMMIT
COGNITO_USER_POOL_ID=${poolId}
COGNITO_USER_POOL_CLIENT_ID=${clientId}
COGNITO_ENDPOINT=${COGNITO_ENDPOINT}
`;
    fs.writeFileSync(".cognito.env", envContent);
    console.log("   Written to .cognito.env");
