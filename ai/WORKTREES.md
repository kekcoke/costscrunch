...
| `p2/cicd` | `feat/p2/cicd` | cicd-agent | SEC-003, SEC-004, BUG-004, BUG-005, BUG-006, BUG-007, BUG-008, CONF-001, CONF-002 | — | pr open | p1/cicd-critical |
| `p2/frontend` | `feat/p2/frontend` | frontend-agent | FE-006, FE-007, FE-008, FE-009, FE-010, FE-011, FE-012, FE-013, FE-014 | — | pr open | p1/backend-critical |
...
| `p3/cicd-cleanup` | `feat/p3/cicd-cleanup` | cicd-agent | cicd-SUG-001, SUG-002, SUG-005, SUG-007 | — | in progress | p2/cicd |
